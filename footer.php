...
background-image: url();">
      ...
      <section class="footer-top-wrapper">
        ...
        <!-- <section>
          <menu>
            ...
            <li>
              <a style="text-decoration: none ; color: white;" href="FaQ.php">Text Classification</a>
            </li>
            <li>
              <a style="text-decoration: none ; color: white;" href="FaQ.php">Duplicates Detector</a>
            </li>
          </menu>
        </section> -->
        ...
        <section>
          <menu>
            <h2 style="margin-bottom: 40px;">Any Grivences?</h2>
        ...
        <section>
          <menu>
            <h2 style="margin-bottom: 40px;">Address</h2>
            <li>
  ...
  <!-- <a style="z-index: 5; position: fixed; bottom: 0; left: 6%; margin-left: 10px; margin-bottom: 10px; "
