...
background-image: url();">
  ...
  <div data-sticky-container>
    <div data-sticky>
      <nav class="navbar navbar-expand-xl " id="NavBar">
        ...
        <div class="navbar-nav ml-auto">
          <a href="admin.php" class="nav-item nav-link active"><i style="color: rgb(255, 255, 255);"
              class="fa fa-home"></i><span style="color: rgb(255, 255, 255);">HOME</span></a>

          <a href="top_donator.php" class="nav-item nav-link"><i class="fa fa-info-circle"></i><span>DONATORS UPDATE</span></a>
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              ...
              <a href="upload_calendar.php" class="dropdown-item">Calendar Update</a>
              <a href="upload_notification.php" class="dropdown-item">Notifications</a>
              <a href="contact_admin.php" class="dropdown-item">ContactUs messages</a>
              <!-- <a href="custmerSupport.php" class="dropdown-item">Customer Support</a> -->
              ...
              <div class="nav-item dropdown">
                <div class="dropdown-menu bookings" style="margin-left: 150px;">
                  <a href="upload_livedarshan.php" class="dropdown-item">Upload Live darshan</a>
                  <!-- <a href="#" class="dropdown-item">Arati booking</a> -->
                  <a href="parking_admin.php" class="dropdown-item">Parking booking</a>
                </div>
              </div>
          ...
          <a href="parking_admin.php" class="nav-item nav-link"><i class="fa fa-money"></i><span>PARKING</span></a>
          <a href="store/admin/admin_login.php" class="nav-item nav-link active"><i style="color: rgb(255, 255, 255);"
    ...
    if (isset($_SESSION['name'])) {
        ...
        font-weight: 600; text-transform: uppercase; ">ADMIN</span></a>
